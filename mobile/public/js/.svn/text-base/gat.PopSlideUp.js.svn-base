(function(win){
    ...
    PopSildeUp.prototype.show = function(obj, oConnected){
        ...
        _this.oClose = _this.oBox.querySelectorAll('.close');
        ...
        $(_this.oClose).click(function(event) {
           _this.closeFn(oConnected);
        });
    ...
    PopSildeUp.prototype.closeFn = function(oConnected){
        var _this = this;
